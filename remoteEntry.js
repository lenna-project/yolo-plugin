...
var moduleMap = {
	...
	"./Widget": () => {
		return Promise.all([__webpack_require__.e(855), __webpack_require__.e(180)]).then(() => (() => ((__webpack_require__(180)))));
	}
};
...
/******/ 					var req = fetch(__webpack_require__.p + "" + {"23":{"840":"7d8f012b75a1adddce32"}}[chunkId][wasmModuleId] + ".module.wasm");
/******/ 					var promise;
